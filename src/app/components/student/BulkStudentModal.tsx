      ...
      >
        <motion.div
          ...
          style={{
            ...
            maxHeight: '88vh',
            background: 'var(--ef-surface)', border: '1px solid var(--ef-border)', borderRadius: 3,
          }}
            ...
            <div className="px-6 py-6 flex-1 overflow-y-auto">
              ...
              <div className="flex items-center justify-between mb-5 px-3 py-2.5"
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs" style={{ color: 'var(--ef-text-subtle)' }}>Download the student template before uploading</span>
                </div>
              ...
              <div
                ...
                style={{
                  ...
                  background: dragOver ? 'var(--ef-canvas)' : 'var(--ef-canvas-raised)', borderRadius: 3,
                }}>
                <Upload size={24} strokeWidth={1} style={{ color: dragOver ? 'var(--ef-ink)' : 'var(--ef-text-muted)', marginBottom: 12 }} />
                <p className="text-sm" style={{ color: dragOver ? 'var(--ef-ink)' : 'var(--ef-text-subtle)' }}>
                  Drag & drop or click to upload
                </p>
                <p className="text-xs mt-1.5" style={{ color: 'var(--ef-text-muted)' }}>CSV or XLSX · Max 500 rows · Max 5 MB</p>
              </div>
              ...
              <div className="mt-5">
                <p className="text-xs mb-2" style={{ color: 'var(--ef-text-muted)', letterSpacing: '0.06em' }}>REQUIRED COLUMNS</p>
              ...
              <div className="flex-1 overflow-y-auto">
                <table className="w-full" style={{ borderCollapse: 'collapse' }}>
                  ...
                  <tbody>
                    {rows.map((row) => (
                      <tr key={row.index}
                        style={{ borderBottom: '1px solid var(--ef-border-subtle)', background: row.valid ? 'transparent' : 'var(--ef-danger-bg)' }}>
                        ...
                        <td className="px-4 py-2.5">
                          <p className="text-xs" style={{ color: 'var(--ef-text-muted)' }}>{row.program || '—'}</p>
                        </td>
                        <td className="px-4 py-2.5">
                          <p className="text-xs" style={{ color: 'var(--ef-text-muted)' }}>{row.degreeLevel || '—'}</p>
                        </td>
                        <td className="px-4 py-2.5">
                          {row.valid ? (
                            ...
                            <span className="text-xs" style={{ color: 'var(--ef-danger)' }}>{row.errors[0]}</span>
                          )}
                        </td>
                      </tr>
                    ))}
