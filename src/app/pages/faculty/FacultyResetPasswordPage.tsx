          ...
          {stage === 'success' ? (
            <motion.div initial={{ opacity: 0, y: 4 }} animate={{ opacity: 1, y: 0 }}>
              <div className="flex flex-col items-center py-6">
                ...
                <button onClick={() => navigate('/faculty/login', { replace: true })}
            ...
            <>
              ...
              <form onSubmit={handleSubmit} noValidate>
                ...
                <div className="mb-5">
                  ...
                  <input type="text" autoFocus autoComplete="off" autoCapitalize="characters"
                    ...
                    style={{ ...inputStyle, fontFamily: 'monospace', letterSpacing: '0.14em' }}
                    onFocus={onFocus} onBlur={onBlur} />
                  {code.length > 0 && code.length < 16 && (
                    <p className="text-xs mt-1" style={{ color: 'var(--ef-text-muted)' }}>
                      {16 - code.length} character{16 - code.length !== 1 ? 's' : ''} remaining
                    </p>
                  )}
                </div>
              ...
              <div className="mt-5">
                <Link to="/faculty/forgot-password"
                  ...
                  onMouseLeave={(e) => ((e.currentTarget as HTMLElement).style.color = 'var(--ef-text-muted)')}>
                  <ArrowLeft size={12} strokeWidth={1.5} />Request a new code
                </Link>
              </div>
            </>
          )}
